...
namespace argos {
   ...
   void CQTOpenGLBlock::DrawLEDs(CBlockEntity& c_entity) {
      /* Draw the LEDs */
   ...
   void CQTOpenGLBlock::Draw(const CBlockEntity& c_entity) {
      /* Draw the body */
